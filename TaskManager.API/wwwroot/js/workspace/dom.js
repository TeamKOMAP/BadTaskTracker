...
export const chatSettingsSound = document.getElementById("chat-settings-sound");
...
export const chatSettingsSwatches = document.getElementById("chat-settings-swatches");
